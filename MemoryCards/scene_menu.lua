...
function scene:createScene( event )
  ...
  for i=1, 3 do
    ...
    local loadButton = display.newText( (i+2) .. "x" .. (i+3), 0, 0, globals.font.bold, 72 )
    
    loadButton.x = 0
    loadButton.y = 120 * i
    loadButton:setFillColor(0, 137/255, 254/255)
  ...
  local loadButton = display.newText( "Back", 0, 0, globals.font.bold, 72 )
    
    loadButton.x = 0
    loadButton.y = 120 * 4
    loadButton:setFillColor(0, 137/255, 254/255)

    loadButton.levelNum = 4
